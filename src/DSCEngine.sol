...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant LIQUIDATION_THRESHOLD = 50; // 200% overcollateralizatized
    uint256 private constant LIQUIDATION_PRECISION = 100;
    uint256 private constant MIN_HEALTH_FACTOR = 1e18;
    uint256 private constant LIQUIDATION_BONUS = 10; // tihs means a 10% bonus
     ...
     * @param amountDscToMit The amount of decentralized stablecoin to mint
     * @notice this function will deposit your collateral and mint DSC in one transaction
     */
    function depositCollateralAndMintDsc(
        address tokenCollateralAddress,
        uint256 amountCollateral,
        uint256 amountDscToMit
    ) external {
        depositCollateral(tokenCollateralAddress, amountCollateral);
        mintDsc(amountDscToMit);
    }
    ...
    function mintDsc(uint256 amountDscToMint) public moreThanZero(amountDscToMint) nonReentrant {
        s_DSCMinted[msg.sender] += amountDscToMint; //could lead to generate a fake amount Dsc minted********************************
     ...
     * @notice your will get a liquidation bonus for taking the users funds
    ...
    /**
     * @dev Low-level internal function, dont call unless the function calling it is checking for health factors being broken
     */
